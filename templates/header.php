...
<?php wp_enqueue_script( 'jqur', get_template_directory_uri() . '/assets-web/js/jquery.min.js', '', '', true ); ?>
...
<header>
  <div class="container">
    <div class="row"> 
      ...
      <div class="col-md-3">
        <div class="logo"> <a href="<?php echo home_url(); ?>"><img src="<?php echo ot_get_option( 'theme_logo' ); ?>" alt="Image" title="Image" /></a> </div>
      </div>
...
<?php */?>
          ...
          <div class="collapse" id="collapseExample">
            <div class="well"> <i class="fa fa-caret-up"></i>
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <div class="column_mtfw"> <?php echo ot_get_option( 'column_one_direction' ); ?> </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6 border_stroke">
                  <div class="column_fss"> <?php echo ot_get_option( 'column_two_direction' ); ?> </div>
                </div>
              </div>
            </div>
          </div>
